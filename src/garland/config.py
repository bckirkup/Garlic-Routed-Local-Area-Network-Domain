...
def config_to_dict(config: SimulationConfig) -> dict[str, Any]:
    ...
    return {
        ...
        "sequential_clear_steps": config.sequential_clear_steps,
        ...
        "glucose_cusum_enabled": config.glucose_cusum_enabled,
        "glucose_cusum_slack_sd": config.glucose_cusum_slack_sd,
        "glucose_cusum_threshold": config.glucose_cusum_threshold,
        "glucose_cusum_clear_steps": config.glucose_cusum_clear_steps,
