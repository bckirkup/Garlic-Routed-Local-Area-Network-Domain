...
_SUMMARY_COLUMNS = [
    ...
    "background_emission_observed_at_threshold_fraction",
    "background_emission_poisson_tail_fraction",
    "background_emission_group_count",
    "background_emission_group_count_excluded_lambda_zero",
    "background_emission_group_sum_counts",
    "background_emission_group_mean_lambda",
    "background_emission_occupancy_buckets",
    "background_window_pearson_dispersion",
    "background_window_observed_at_threshold_fraction",
    "background_window_poisson_tail_fraction",
    "background_window_group_count",
    "background_window_group_count_excluded_lambda_zero",
    "background_window_group_sum_counts",
    "background_window_group_mean_lambda",
    "background_window_occupancy_buckets",
    "background_window_length_bins",
    ...
    "background_settled_emission_poisson_tail_fraction",
    "background_settled_emission_group_count",
    "background_settled_emission_group_count_excluded_lambda_zero",
    "background_settled_emission_group_sum_counts",
    "background_settled_emission_group_mean_lambda",
    ...
    "background_settled_window_poisson_tail_fraction",
    "background_settled_window_group_count",
    "background_settled_window_group_count_excluded_lambda_zero",
    "background_settled_window_group_sum_counts",
    "background_settled_window_group_mean_lambda",
    "background_settled_window_occupancy_buckets",
    "background_settled_window_length_bins",
    "background_settled_population_variance_to_mean",
    "background_agent_count",
    "background_agent_mean_tokens",
    "background_agent_sd_tokens",
    "background_agent_variance_to_mean",
